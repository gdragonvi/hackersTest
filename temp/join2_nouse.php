            ...
            $('#checkButton').click(function () {
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response == 'success') {
                            $("#message").html("<p style='color:green;font-weight:bold'>인증 성공!</p><a href='../view/join3.php'>넘어가기</a>");
                        } else {
                            $("#message").html("<p style='color:red;font-weight:bold'>인증 실패!</p>");
                        }
                    }
                });
                return false;
			...
			<div class="section-content after">
				<div class="identify-box" style="width:100%;height:190px;">
					<div class="identify-inner">
						...
						<br />
                        <form id="form2" name="form2" action="../Controller/join/phoneOk_nouse.php" method="post">
						<input type="text" class="input-text" name="phoneNum1" style="width:50px"/> -
						<input type="text" class="input-text" name="phoneNum2" style="width:50px"/> -
						<input type="text" class="input-text" name="phoneNum3" style="width:50px"/>
                        <input type="submit" class="btn-s-line" id="phoneButton" value="인증번호 받기">
                            <div id = "message2"></div>
                        </form>
						<br /><br />
                        <form id="form1" name="form1" action="../Controller/join/numberOk_NoUse.php" method="post">
						<input type="text" class="input-text" id="checkNum" style="width:200px"/>
						<input type="button" class="btn-s-line" id="checkButton" value="인증번호 확인">
                            <div id = "message"></div>
					</div>
