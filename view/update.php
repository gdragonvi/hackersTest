...
<div id="container" class="container-full">
    <div id="content" class="content">
        <div class="inner">
            ...
            <form method="POST" name="memberInfo" autocomplete="on" action="../Database/updateTest.php">
                <div class="section-content">
                    <table border="0" cellpadding="0" cellspacing="0" class="tbl-col-join">
                        ...
                        <tr>
                            ...
                            ?>
                            <td><input type="text" class="input-text" style="width:302px" name="memberName" value="<?php echo $name?>" disabled/></td>
                        </tr>
                        <tr>
                            ...
                            ?>
                            <td><input type="text" class="input-text" style="width:302px" name="id" value = "<?php echo $id?>" disabled />
                        ...
                        <tr>
                            ...
                            <?php
                            $email = explode("@",$_SESSION['session_email']);
                            ?>
                            <td>
                                <input type="text" class="input-text" id="email1" name="email[]"style="width:138px" value="<?php echo $email[0]?>"/>
                                @
                                <input type="text" class="input-text" id="email2" value="<?php echo $email[1]?>" style="width:138px" />
                        ...
                        <tr>
                            ...
                            <td>
                                <?php
                                $phoneNumber = explode("-",$_SESSION['session_phone']);
                                ?>
                        ...
                        <tr>
                            ...
                            <?php
                            $homePhoneNumber = explode("-",$_SESSION['session_homePhoneNum']);
                            ?>
                            <td><input type="text" class="input-text" name="homeNum[]" style="width:88px" value="<?php echo $homePhoneNumber[0]?>"/> -
                                <input type="text" class="input-text" name="homeNum[]" style="width:88px" value="<?php echo $homePhoneNumber[1]?>"/> -
                                <input type="text" class="input-text" name="homeNum[]" style="width:88px" value="<?php echo $homePhoneNumber[2]?>"/></td>
                        </tr>
                        <tr>
                            <th scope="col"><span class="icons">*</span>주소</th>
                            <?php
                            $address = explode(",",$_SESSION['session_address']);
                            ?>
                            <td>
                                <p >
                                ...
                                <p class="mt10">
                                    <label>기본주소 <input type="text" class="input-text ml5" name="address[]" id="roadAddress" style="width:719px" value="<?php echo $address[0]?>"/></label>
                                </p>
                                <p class="mt10">
                                    <label>상세주소 <input type="text" class="input-text ml5" name="address[]" id="jibunAddress" style="width:719px" value="<?php echo $address[1]?>"/></label>
                                </p>
                            </td>
                        </tr>
                        <tr>
