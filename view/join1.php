...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        $("#submitbutton").click(function(){
            if($("input:checkbox[name='check']:checked").length!=2){
                alert("동의를 체크해주세요.");
                return false;
            }
        });
    ...
    $(document).ready(function () {
        $("input:checkbox[name='checkAll']").click(function () {
            ...
            if(chk) $("input:checkbox[name='check']").prop('checked',true);
...
2010년 4월 23일부터 시행되던 종전의 약관은 본 약관으로 대체됩니다.
						<form action="join2.php" onsubmit="return checkForm()">
					</div>
...
*이전 개인정보취급방침 보기(2014년 2월 1일부터 시행된 방침) 
			...
			<div class="box-btn">
				<div class="btn-l">
					<input type="submit" class="btn-l" id="submitbutton" value="다음단계 (휴대폰인증)">
			</div>
		</form>
		</div>
	</div>
