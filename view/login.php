...
<div class="login-section">
	...
	<div class="login-inner">
		...
		<div class="box-login">
			<form id="form1" name="form1" action="../Database/loginCheck.php" method="post">
			<div class="login-input">
				<div class="input-text-box">
					<input type="text" id="user_id" name="user_id" class="input-text mb5" placeholder="아이디" style="width:190px"/>
					<input type="password" id="user_pwd" name="user_pwd" class="input-text" placeholder="비밀번호" style="width:190px"/>
				</div>
				<input type="submit" id="login" class="btn-login" value="로그인">
			</div>
            </form>
			...
			<div class="box-btn">
				<a href="../view/join3.php" class="btn-m-gray">회원가입</a>
				<a href="../view/findId.php" class="btn-m-gray">ID/PW 찾기</a>
			</div>
		</div>
